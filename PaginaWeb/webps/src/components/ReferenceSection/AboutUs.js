  ...
  return (
    <div className="min-h-screen py-26 sm:py-10" style={containerStyle}>
      <div className="text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl animate-bounce">
          Acerca de nosotros: Proyecto de Psicologia
        </h2>
        <p className="mt-3 text-lg leading-8 text-gray-600 tracking-tight text-center mx-14">
          ¡Hola a todos! Somos un equipo de estudiantes de la Universidad de
          Guadalajara, comprometidos en completar nuestro proyecto modular como
          parte integral de nuestra carrera. Como apasionados de la
          programación, nos encanta explorar nuevas tecnologías, innovar y estar
          en constante aprendizaje. Nuestro objetivo es brindar soluciones
          tecnológicas creativas y de calidad, aprovechando nuestra formación
          académica y nuestras habilidades técnicas. Estamos entusiasmados por
          compartir nuestro conocimiento y experiencia mientras trabajamos en
          colaboración para alcanzar el éxito en nuestros proyectos.
      ...
      <div className="mt-20 mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        ...
        <ul
          role="list"
          className="grid gap-x-6 gap-y-12 sm:grid-cols-2 sm:gap-y-4 xl:col-span-2"
        >
          {people.map((person) => (
            <li key={person.name}>
